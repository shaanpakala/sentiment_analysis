...
*notes: 98.5% seems like a pretty high accuracy for this model but I can't find any errors in my logic (train data and test data are separate). Training and testing is done on notebook 6 if you want to check it out. Also the performance seems to be not nearly as good outside of the data used in this project (online reviews, and the kaggle twitter and reddit data).*
